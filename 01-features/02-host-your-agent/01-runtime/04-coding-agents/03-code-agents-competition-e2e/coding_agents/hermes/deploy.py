"""
Deploy Hermes runtime to AgentCore.
...
AGENT_NAME = local.get("AGENT_NAME", "hermes")
...
def create_execution_role() -> str:
    ...
    ecr_repo = ECR_URI.split("/")[1].split(":")[0] if "/" in ECR_URI else "coding-agents-hermes"
    ...
    if existing_id:
        try:
            ...
            control.update_agent_runtime(
                ...
                description="Hermes coding agent with Bedrock inference",
            )

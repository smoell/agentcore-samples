"""
Delete the Codex AgentCore runtime, its IAM role, and Identity resources.
...
WORKLOAD_NAME = "codex-coding-agent"
...
def main():
    parser = argparse.ArgumentParser(description="Clean up Codex AgentCore runtime")
    parser.add_argument(

"""
Deploy Cursor (PTY/WebSocket) runtime to AgentCore.
...
AGENT_NAME = local.get("AGENT_NAME", "cursor")
...
def create_execution_role() -> str:
    ...
    ecr_repo = ECR_URI.split("/")[1].split(":")[0] if "/" in ECR_URI else "coding-agents-cursor"

"""
Deploy a LangGraph + Bedrock agent to AgentCore Runtime using direct code deployment.
...
AGENT_NAME = f"langgraph_bedrock_{int(time.time()) % 100000}"
PROTOCOL = "HTTP"
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="LangGraph agent with Bedrock model — tutorial example",
    )

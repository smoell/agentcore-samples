"""
Deploy an A2A agent to AgentCore Runtime.

Uses direct code deployment (zip to S3) — no Docker required.
The key difference from HTTP deployment: serverProtocol is set to 'A2A'.
...
def create_runtime(role_arn: str) -> dict:
    ...
    # Note: serverProtocol is 'A2A' — this is the key difference
    response = control.create_agent_runtime(
        ...
        description="A2A documentation assistant agent",
    )

"""
Deploy the middleware agent to AgentCore Runtime.

This agent demonstrates Starlette middleware for observability and error handling.
...
ENTRY_POINT = "middleware_agent.py"
CODE_FILES = ["middleware_agent.py", "requirements.txt"]
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="Middleware demo — observability and error handling middleware",
    )

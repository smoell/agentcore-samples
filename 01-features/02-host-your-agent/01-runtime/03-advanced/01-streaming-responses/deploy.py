"""
Deploy the streaming agent to AgentCore Runtime.
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="Streaming agent — demonstrates SSE responses",
    )
...
def main():
    ...
    print(f"Deploying {AGENT_NAME} (direct code deployment)\n")

"""
Deploy the MCP progress notifications e2e agent to AgentCore Runtime.

This MCP server demonstrates progress notifications during long-running
operations like generating a monthly financial report.
...
AGENT_NAME = "mcp_progress_e2e"
PROTOCOL = "MCP"
PYTHON_RUNTIME = "PYTHON_3_13"
ENTRY_POINT = "mcp_progress_server.py"
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="MCP progress e2e — progress notifications during report generation",
    )

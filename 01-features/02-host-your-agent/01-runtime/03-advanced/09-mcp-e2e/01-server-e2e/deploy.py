"""
Deploy the MCP server e2e agent to AgentCore Runtime.

This MCP server demonstrates tools, resources, and prompts using a
finance tracking example backed by DynamoDB.
...
AGENT_NAME = "mcp_server_e2e"
PROTOCOL = "MCP"
PYTHON_RUNTIME = "PYTHON_3_13"
ENTRY_POINT = "mcp_e2e_stateless_server.py"
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="MCP server e2e — tools, resources, and prompts with DynamoDB",
    )

"""
Deploy the session management demo agent.

This agent is configured with a longer idle timeout (30 minutes)
to give you time to experiment with sessions.
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        # Longer idle timeout so you have time to experiment with sessions
        lifecycleConfiguration={"idleRuntimeSessionTimeout": 1800, "maxLifetime": 7200},
        description="Session management demo — 30min idle timeout",
    )

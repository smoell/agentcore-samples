"""Demo: Strands Agent calling Lambda MCP tools via AgentCore Gateway.

Connects a Strands Agent to the gateway and invokes tools via natural language.

Requires GATEWAY_URL and COGNITO_STACK_NAME environment variables.

Usage:
    uv run python scripts/lambda-oauth/strands.py
"""

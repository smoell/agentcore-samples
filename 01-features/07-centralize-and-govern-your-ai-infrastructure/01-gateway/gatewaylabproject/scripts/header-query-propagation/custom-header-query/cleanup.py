"""Clean up resources created by deploy.py for the custom-header-query tutorial.
...
def main():
    ...
    admin.delete_credential_provider("header-query-mcp-oauth")
    ...
    print("\nDone. Now run:")
    print(
        "  uv run python scripts/cleanup_gateway.py --name header-query-gateway"

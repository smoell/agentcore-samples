...
| Lab | Description |
|-----|-------------|
| [01-getting-started](./01-getting-started.md) | Deploy a private API gateway with mock integrations and connect it to AgentCore gateway. No domain or certificate needed — uses the API-VPCE DNS format. |
| [02-peering](./02-peering.md) | Connect to a Private API gateway in a peered VPC (cross-region) using managed VPC resource and VPC peering. |

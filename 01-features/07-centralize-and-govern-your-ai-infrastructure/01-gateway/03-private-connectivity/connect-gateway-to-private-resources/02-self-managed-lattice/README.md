...
|----------|-------------|
| [01-getting-started](./01-getting-started.md) | Create a self-managed Resource gateway and Resource Configuration, then connect to AgentCore gateway. |
| [02-cross-account](./02-cross-account.md) | Share a Resource Configuration across accounts using AWS RAM. |

...
|----------|-------------|
| [01-private-domain](./01-private-domain.md) | Connect AgentCore gateway to a privately resolvable endpoint |
| [02-private-certificate-authority](./02-private-certificate-authority.md) | Use the ALB workaround for APIs with AWS Private CA certificates. |
| [03-self-signed-certificate](./03-self-signed-certificate.md) | Use the ALB workaround for APIs with self-signed certificates (no Private CA cost). |
| [04-static-gateway-ip](./04-static-gateway-ip.md) | Route AgentCore gateway traffic through a NAT gateway with a static Elastic IP for allowlisting. |

...
interface OAuthFlowProgressProps {
	...
	onApplyAccessTokenAsHeader?: (accessToken: string) => void;
}
								...
								authState.oauthTokens.access_token && (
									<Button
										...
										onClick={() => {
											...
											toast({
												title: "Authorization header set",
												description:
													"Access token copied to Custom Headers → Authorization.",
											});
										}}
									>

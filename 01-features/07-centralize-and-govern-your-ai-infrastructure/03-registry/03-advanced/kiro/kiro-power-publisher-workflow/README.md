...
The Kiro Power Publisher workflow is IDE-driven via the Kiro chat interface using
the `POWER.md` steering document — there is no standalone Python script to run.

Refer to the example prompts above to interact with the registry through Kiro.

...
> **Note:** The script requires `deploy.sh` and `destroy.sh` to be present and executable.
> Run `chmod +x deploy.sh destroy.sh` before executing the script.
> CloudFormation stack deployment takes ~3–5 minutes.

...
> **Note:** The script deploys two AgentCore runtime containers (OAuth-protected and
> IAM-protected MCP servers). Full deployment takes 5–10 minutes per runtime.
> Cleanup is performed at the end of the script.

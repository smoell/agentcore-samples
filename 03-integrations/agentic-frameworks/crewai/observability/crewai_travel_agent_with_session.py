"""
AgentCore Observability — CrewAI Travel Agent with Session Tracking.

Extends crewai_travel_agent.py by attaching a session ID to OpenTelemetry baggage
so that all spans from this run are grouped under one session in CloudWatch GenAI
Observability.

Usage:
    opentelemetry-instrument python crewai_travel_agent_with_session.py --session-id "session-123"
"""

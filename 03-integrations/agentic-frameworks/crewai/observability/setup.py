"""
Setup script — creates the CloudWatch log group and log stream for CrewAI observability.
...
LOG_GROUP = "agents/crewai-agent-logs"
LOG_STREAM = "default"
...
def main():
    parser = argparse.ArgumentParser(
        description="Create CloudWatch log group/stream for CrewAI observability"
    )
    parser.add_argument(

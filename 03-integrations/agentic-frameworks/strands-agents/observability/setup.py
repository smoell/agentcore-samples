"""
Setup script — creates the CloudWatch log group and log stream for Strands observability.
...
LOG_GROUP = "agents/strands-agent-logs"
LOG_STREAM = "default"
...
def main():
    parser = argparse.ArgumentParser(
        description="Create CloudWatch log group/stream for Strands observability"
    )
    parser.add_argument(

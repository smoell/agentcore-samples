"""
Deploy the Travel Agent with Braintrust observability to AgentCore Runtime.

Usage:
    cp .env.example .env  # fill in your Braintrust credentials
    python deploy.py
"""
...
AGENT_NAME = f"braintrust_obs_{int(time.time()) % 100000}"
PROTOCOL = "HTTP"
...
def create_runtime(role_arn: str) -> dict:
    ...
    response = control.create_agent_runtime(
        ...
        description="Travel agent with Braintrust observability",
    )

...
def get_ecr_policy(
    account_id: str, regions: List[str], repository_name: str = "bedrock-agentcore"
) -> Dict[str, Any]:
    """
...
def get_logs_policy(account_id: str, regions: List[str]) -> List[Dict[str, Any]]:
    ...
    log_group_describe = {
        ...
        "Resource": [
            f"arn:aws:logs:{region}:{account_id}:log-group:*" for region in regions
        ],
    }
...
def get_bedrock_agentcore_policy(
    account_id: str, regions: List[str], agent_name: str = "insurance-agent"
) -> Dict[str, Any]:
    """
...
def build_execution_policy(config_data: Dict[str, Dict[str, str]]) -> Dict[str, Any]:
    ...
    repository_name = config_data.get("ecr", {}).get(
...
def write_policy_files(
    config_data: Dict[str, Dict[str, str]], output_dir: str = "."
) -> Dict[str, str]:
    """

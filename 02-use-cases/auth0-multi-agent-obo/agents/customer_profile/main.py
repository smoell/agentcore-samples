...
"""
Main entry point for the Customer Profile Agent using bedrock_agentcore SDK.
...
async def invoke(payload, context=None):
    """
    Main entry point for customer profile agent invocations.
    ...
    try:
        ...
        # Note: Coordinator sends "prompt", but we also accept "query" for direct calls

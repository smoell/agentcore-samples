"""
Deploy Property Search Agent to Bedrock AgentCore Runtime

This script deploys the Property Search Agent using the bedrock-agentcore-starter-toolkit.
"""
...
print("=" * 60)
print("Deploying Property Search Agent to AgentCore Runtime")
print("=" * 60)
print()

# Configuration
agent_name = "property_search_agent"  # Must use underscores, not hyphens
